...
// Validation method datanot para comparar com data atual
        ...
        $("#cadastro_sv2_covid").validate({
            ...
            messages: {
                ...
                protocolo: {
                    required:"Digite um Protocolo válido",
                    rangelength:"Min 5 e Máx de 13 numeros"
                },
                datanot: {
        ...
        $("#cadastro_sv2_covid_outros").validate({
            rules: {
                sinan: {
                    required: true,
                    rangelength: [5, 7]
        ...
        $("#edicao_sv2_covid_outros").validate({
            rules: {
                sinan: {
                    required: true,
                    rangelength: [5, 7]
