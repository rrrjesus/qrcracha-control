...
// Validation method datanot para comparar com data atual
    ...
    $("#cadastro_sv2_siva").validate({
        rules: {
            ...
            agravo: {
                required: true,
                remote: "remote/sv2/val-agravosiva.php"
            },
            dataentrada: {
                required: true,
                dateBR: true,
        ...
        messages: {
            ...
            agravo: {
                required: "Informe o agravo de siva notificado",
                remote: "Agravo de Siva não encontrado"
            },
            sexo: {
    ...
    $("#edicao_sv2_siva").validate({
        ...
        $("#cadastro_sv2_siva_outros").validate({
            rules: {
                sinan: {
                    required: true,
                    rangelength: [5, 7]
            ...
            messages: {
                ...
                suvis: {
                    ...
                    minlength: "Digite uma suvis válida",
                    remote:"Edite com uma Suvis diferente de JACANA-TREMEMBÉ ou Digite:OUTROS"
                },
                localvd: {
    ...
    $("#edicao_sv2_siva_outros").validate({
        rules: {
            sinan: {
                required: true,
                rangelength: [5, 7]
