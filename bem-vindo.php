   ...
   <!-- START THE FEATURETTES -->
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-4">
            ...
            <p>Acesse nosso site <a class="fw-bold" href="/../jacana-control/">Jaçanã Controle</a> e acompanhe as novidades !!!, lá você encontra diversos tutoriais sobre funções e funcionamento de todo o sistema <strong>Jaçanã Controle</strong> .</p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="bd-placeholder-img rounded-circle" width="140" height="140" role="img" src="imagens/site.jpg">
