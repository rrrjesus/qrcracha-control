    ...
    <fieldset <?php if ($usuarioid == 1) :  echo 'disabled'; endif; ?>>
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2 justify-content-center">
                <div class="col-2 style="10px" mb-1 text-center">
                ...
                <div class="col-7 text-center">
                    ...
                    <p class="h6 text-secondary mt-0 mb-0 ms-2" style="font-size: 40px;font-weight: 900">RGE <?=date('Y')?></p>
                </div>
            ...
            <div class="row mb-0 mt-0  justify-content-center">
                ...
                <div class="col-8 text-center">
                    <p class="text-dark fw-bold mb-0" style="font-size: 0.70rem; margin-left:10px">Suporte: informatica.setor11@gmail.com</p>
                </div>
            </div>
            <br><br><br><br><br><br>
