...
<div class="row">
    ...
    <div class="col-md-6">
        <img src="imagens/index/img_login.jpeg" alt="Login" class="img-fluid">
    </div>
        ...
        <form class="needs-validation p-2" novalidate id="head-login" method="POST" action="locked/valida-login.php">
            ...
            <div class="row mb-2 row justify-content-center">
                <div class="col-10 col-md-6">
                    ...
                    ?>
                        <input type="password" class="form-control" id="senha" name="senha" data-toggle="tooltip" data-placement="top" required
