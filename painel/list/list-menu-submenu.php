        ...
        <div class="page-content">
            ...
            <script type="text/javascript" class="init">
                $(document).ready(function() {
                    $('#list-menu-submenu').DataTable({"language": {"sEmptyTable": "Nenhum registro encontrado","sInfo": "Mostrando de _START_ até _END_ de _TOTAL_ registros",
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="text-center">
                        <a href="././<?php echo $admin?>?pag=cad-menu-submenu">
                    ...
                    <table id="list-menu-submenu" class="table table-hover table-striped table-bordered" cellspacing="0"
                           width="100%">
                        <thead>
                        <tr>
                        ...
                        <tr style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                            ...
                            <td class="text-center">
                                <a href='././<?php echo $admin?>?pag=edit-menu-submenu&id=<?php echo $row_menus_submenus['id']; ?>'>
                            ...
                            <div class="modal-dialog modal-sm" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <div class="text-center">
                                            <a href='<?php echo $admin?>?pag=del-menu-submenu&id=<?php echo $row_menus_submenus['id']; ?>'>
