        ...
        <div class="card-body">
            <div class="row d-block d-xl-flex align-items-center">
                <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                    ...
                    <div class="d-sm-none"><h2 class="h5">Customers</h2>
                        <h3 class="mb-1">345,678</h3></div>
                </div>
                <div class="col-12 col-xl-7 px-xl-0">
                    <div class="d-none d-sm-block"><h2 class="h5">Customers</h2>
                        <h3 class="mb-1">345k</h3></div>
                    ...
                    <div class="small mt-2"><span class="fas fa-angle-up text-success"></span> <span
                            class="text-success fw-bold">18.2%</span> Since last month
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row d-block d-xl-flex align-items-center">
                <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                    ...
                    <div class="d-sm-none"><h2 class="h5">Revenue</h2>
                        <h3 class="mb-1">$43,594</h3></div>
                </div>
                <div class="col-12 col-xl-7 px-xl-0">
                    <div class="d-none d-sm-block"><h2 class="h5">Revenue</h2>
                        <h3 class="mb-1">$43,594</h3></div>
                    <small>Feb 1 - Apr 1, <span class="icon icon-small"><span
                                class="fas fa-globe-europe"></span></span> Worldwide</small>
                    <div class="small mt-2"><span class="fas fa-angle-up text-success"></span> <span
                            class="text-success fw-bold">28.2%</span> Since last month
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card border-light shadow-sm">
        <div class="card-body">
            <div class="row d-block d-xl-flex align-items-center">
                ...
                <div class="col-12 col-xl-7 px-xl-0"><h2 class="h5 mb-3">Traffic Share</h2><h6
                        class="fw-normal text-gray"><span class="icon w-20 icon-xs icon-secondary me-1"><span
                                class="fas fa-desktop"></span></span> Desktop <a href="#" class="h6">60%</a>
                    </h6><h6 class="fw-normal text-gray"><span class="icon w-20 icon-xs icon-primary me-1"><span
        ...
        <div class="card-body d-flex flex-row align-items-center flex-0 border-bottom">
            ...
            <div class="d-block ms-auto">
                <div class="d-flex align-items-center text-right mb-2"><span
                        ...
                        class="fw-normal small">July</span></div>
...
<div class="col-12 col-lg-6 col-xl-4 mb-4">
    <div class="card border-light shadow-sm">
        <div class="card-body d-flex flex-row align-items-center flex-0 border-bottom">
            ...
            <div class="d-block ms-auto">
                <div class="d-flex align-items-center text-right mb-2"><span
                        class="shape-xs rounded-circle bg-dark me-2"></span> <span class="fw-normal small">Google</span>
                </div>
                <div class="d-flex align-items-center text-right mb-2"><span
    ...
    <div class="card border-light shadow-sm">
        <div class="card-body d-flex flex-row align-items-center flex-0 border-bottom">
            ...
            <div class="d-block ms-auto">
                ...
                <div class="d-flex align-items-center text-right mb-2"><span
                        class="shape-xs rounded-circle bg-dark me-2"></span> <span
                        class="fw-normal small">Paid</span></div>
            </div>
        </div>
        <div class="card-body p-2">
...
<div class="row">
    <div class="col-12 col-xl-8 mb-4">
        <div class="row">
                ...
                <div class="card border-light shadow-sm">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col"><h2 class="h5">Páginas Visitadas</h2></div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col">Visualizações da Página</th>
            ...
            <div class="col-12 col-lg-6 mb-4">
                <div class="card border-light shadow-sm">
                    <div class="card-header border-bottom border-light d-flex justify-content-between"><h2
                            class="h5 mb-0">Team members</h2><a href="../users.html"
                                                                class="btn btn-sm btn-secondary">See all</a></div>
                    <div class="card-body">
                        <ul class="list-group list-group-flush list my--3">
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"><a href="#" class="user-avatar"><img class="rounded-circle"
                                                                                               ...
                                                                                               src="../../assets/img/team/profile-picture-1.jpg"></a>
                                    </div>
                                    <div class="col-auto ms--2"><h4 class="h6 mb-0"><a href="#!">Chris Wood</a></h4>
                                        <span class="text-success">●</span> <small>Online</small></div>
                                    <div class="col text-right"><a href="../calendar.html"
                                                                   class="btn btn-sm btn-tertiary"><i
                                                class="fas fa-calendar-check me-1"></i> Invite</a></div>
                                </div>
                            </li>
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"><a href="../users.html" class="user-avatar"><img
                                                class="rounded-circle" alt="Image placeholder"
                                                src="../../assets/img/team/profile-picture-2.jpg"></a></div>
                                    <div class="col-auto ms--2"><h4 class="h6 mb-0"><a href="#!">Jose Leos</a></h4><span
                                            class="text-warning">●</span> <small>In a meeting</small></div>
                                    <div class="col text-right"><a href="../single-message.html"
                                                                   class="btn btn-sm btn-tertiary"><i
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"><a href="#" class="user-avatar"><img class="rounded-circle"
                                                                                               alt="Image placeholder"
                                                                                               src="../../assets/img/team/profile-picture-3.jpg"></a>
                                    </div>
                                    <div class="col-auto ms--2"><h4 class="h6 mb-0"><a href="#!">Bonnie Green</a></h4>
                                        <span class="text-danger">●</span> <small>Offline</small></div>
                                    <div class="col text-right"><a href="../calendar.html"
                                                                   class="btn btn-sm btn-tertiary"><i
                                                class="fas fa-calendar-check me-1"></i> Invite</a></div>
                                </div>
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    <div class="col-auto"><a href="#" class="user-avatar"><img class="rounded-circle"
                                                                                               alt="Image placeholder"
                                                                                               src="../../assets/img/team/profile-picture-4.jpg"></a>
                                    </div>
                                    <div class="col-auto ms--2"><h4 class="h6 mb-0"><a href="#">Neil Sims</a></h4><span
                                            class="text-success">●</span> <small>Online</small></div>
                                    <div class="col text-right"><a href="../single-message.html"
                                                                   class="btn btn-sm btn-tertiary"><i
                                                class="fas fa-comment me-1"></i> Message</a></div>
                                </div>
            ...
            <div class="col-12 col-lg-6 mb-4">
                <div class="card border-light shadow-sm">
                    <div class="card-header border-bottom border-light"><h2 class="h5 mb-0">Progress track</h2></div>
                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="progress-wrapper">
                                    ...
                                    <div class="progress mb-0">
                                        <div class="progress-bar bg-purple" role="progressbar" aria-valuenow="34"
                        ...
                        <div class="row align-items-center mb-4">
                            ...
                            <div class="col">
                                <div class="progress-wrapper">
                                    ...
                                    <div class="progress mb-0">
                                        <div class="progress-bar bg-tertiary" role="progressbar" aria-valuenow="45"
                        ...
                        <div class="row align-items-center mb-4">
                            <div class="col-auto"><span class="icon icon-md text-info"><span
                                        class="fab fa-react"></span></span></div>
                            <div class="col">
                                <div class="progress-wrapper">
                                    <div class="progress-info">
            ...
            <div class="col-12">
                <div class="card border-light shadow-sm">
                    <div class="card-header border-bottom border-light"><h2 class="h5 mb-0">Events</h2></div>
                    <div class="card-body">
                        <div class="row align-items-center d-block d-sm-flex border-bottom border-light pb-4 mb-4">
                            ...
                            <div class="col"><a href="../calendar.html"><h3 class="h5">Newmarket Nights</h3></a><span>Organized by <a
                                        href="#!" class="text-700">University of Oxford</a></span>
                                <div class="small fw-bold mt-1">Time: 6:00AM</div>
                                <span class="small fw-bold">Place: Cambridge Boat Club, Cambridge</span></div>
                        </div>
                        <div class="row align-items-center d-block d-sm-flex border-bottom border-light pb-4 mb-4">
                            <div class="col-auto mb-3 mb-sm-0">
                            ...
                            <div class="col"><a href="../calendar.html"><h3 class="h5 mb-0">Noco Hemp Expo</h3>
                                ...
                                <span class="small fw-bold">Place: Denver Expo Club, USA</span></div>
                        </div>
                        <div class="row d-block d-sm-flex align-items-center">
                            ...
                            <div class="col"><a href="../calendar.html"><h3 class="h5 mb-0">Canadian National Exhibition
                                        (CNE)</h3></a><span>Organized by <a href="#!" class="text-700">University of Oxford</a></span>
                                <div class="small fw-bold mt-1">Fri, 20 Sep - Mon, 07 Oct 2020</div>
                                <span class="small fw-bold">Place: Toronto , Canada</span></div>
                        </div>
                    </div>
                    <div class="card-footer border-top border-light text-center"><a class="fw-bold text-primary"
                                                                                    href="../calendar.html">See all</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-xl-4 mb-4">
            ...
            <div class="card border-light shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between border-bottom border-light pb-3">
                        <div><h6 class="mb-0"><span class="icon icon-xs me-3"><span class="fas fa-globe-europe"></span></span>Global
                                Rank</h6></div>
                        <div><a href="#" class="text-primary fw-bold">#755<span
                                    class="fas fa-chart-line ms-2"></span></a></div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between border-bottom border-light py-3">
                        <div><h6 class="mb-0"><span class="icon icon-xs me-3"><span
                                        class="fas fa-flag-usa"></span></span>Country Rank</h6>
                        ...
                        <div><a href="#" class="text-primary fw-bold">#32<span
                                    class="fas fa-chart-line ms-2"></span></a></div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between pt-3">
                        <div><h6 class="mb-0"><span class="icon icon-xs me-3"><span
                                        class="fas fa-folder-open"></span></span>Category Rank</h6><a href="#"
                                                                                                      class="small card-stats">Travel
                                > Accomodation</a></div>
                        <div><a href="#" class="text-primary fw-bold">#16<span
                                    class="fas fa-chart-line ms-2"></span></a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 px-0 mb-4">
            <div class="card border-light shadow-sm">
                <div class="card-body"><h2 class="h5">Acquisition</h2>
                    ...
                    <div class="d-block">
                        <div class="d-flex align-items-center pt-3 me-5">
                            ...
                            <div class="d-block"><label class="mb-0">Bounce Rate</label><h4 class="mb-0">33.50%</h4>
                            </div>
                        </div>
                        <div class="d-flex align-items-center pt-3">
                            <div class="icon icon-shape icon-sm icon-shape-quaternary rounded me-3"><span
                                    class="fas fa-chart-area"></span></div>
                            <div class="d-block"><label class="mb-0">Sessions</label><h4 class="mb-0">9,567</h4></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 px-0">
            <div class="card border-light shadow-sm">
                <div class="card-header pb-0"><h2 class="h5">Visits past 30 days by country</h2>
                    <div id="map" style="width: 100%; height: 300px"></div>
                </div>
                <div class="card-body">
                    <div class="row align-items-center mb-4">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder"
                                    src="../../assets/img/flags/united-states-of-america.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    <div class="h6 mb-0">United States <span
                                            class="text-gray font-small">(272.109)</span></div>
                                    <div class="small fw-bold text-dark"><span>34 %</span></div>
                                </div>
                                <div class="progress mb-0">
                                    <div class="progress-bar bg-dark" role="progressbar" aria-valuenow="34"
                                         aria-valuemin="0" aria-valuemax="100" style="width: 34%;"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder" src="../../assets/img/flags/canada.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    <div class="h6 mb-0">Canada <span class="text-gray font-small">(160.064)</span>
                                    </div>
                                    <div class="small fw-bold text-dark"><span>20 %</span></div>
                                </div>
                                <div class="progress mb-0">
                                    <div class="progress-bar bg-secondary" role="progressbar" aria-valuenow="20"
                                         aria-valuemin="0" aria-valuemax="100" style="width: 24%;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row align-items-center mb-4">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder" src="../../assets/img/flags/germany.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    <div class="h6 mb-0">Germany <span class="text-gray font-small">(120.048)</span>
                                    </div>
                                    <div class="small fw-bold text-dark"><span>15 %</span></div>
                                </div>
                                <div class="progress mb-0">
                                    <div class="progress-bar bg-tertiary" role="progressbar" aria-valuenow="15"
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder" src="../../assets/img/flags/france.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    <div class="h6 mb-0">France <span class="text-gray font-small">(100.048)</span>
                                    </div>
                                    <div class="small fw-bold text-dark"><span>8 %</span></div>
                                </div>
                                <div class="progress mb-0">
                                    <div
                                        aria-valuemax="100" aria-valuemin="0" aria-valuenow="8" class="progress-bar"
                                        role="progressbar"
                                        style="width: 8%;"></div>
                                </div>
                            </div>
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder" src="../../assets/img/flags/japan.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder" src="../../assets/img/flags/italy.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                    ...
                    <div class="row align-items-center mb-4">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder" src="../../assets/img/flags/netherlands.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
                                    <div class="h6 mb-0">Netherlands <span class="text-gray font-small">(40.016)</span>
                                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto"><a href="#" class="image image-xs rounded-circle"><img
                                    alt="Image placeholder" src="../../assets/img/flags/sweden.svg"></a></div>
                        <div class="col">
                            <div class="progress-wrapper">
                                <div class="progress-info">
