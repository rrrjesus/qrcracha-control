...
include_once 'proc-cad-admin/proc-cad-menu-submenu.php';
?>
...
<div class="container-fluid">
    ...
    <div id="page-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form class="form-horizontal" id="cadastro_menu_submenu" method="POST" action="">
                        <div class="form-group">
                            <div class="col-sm-5">
                                <label for="inputIdMenu">Id Menu SubMenu</label>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <label for="inputNomeSubMenu">Nome Menu SubMenu</label>
                                <input type="text" data-toggle="tooltip" title="Digite um menu submenu"
                                       style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                                           echo 'display: none;';
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                ...
                                <input type="text" data-toggle="tooltip" title="Digite uma página"
                                       style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                                           echo 'display: none;';
                                       } ?>" class="form-control" name="pag" value="menu-principal.php?pag="
                                       placeholder=menu-principal.php?pag=cad-caminho">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <button style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                                    echo 'display: none;';
                                } ?>" type="submit" name="btnCadMenuSubMenu" value="Cadastrar" accesskey="G"
                                        style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                                            echo 'display: none;';
                                ...
                                <a href='././<?php echo $admin ?>?pag=list-menu-submenu'
