...
include_once 'proc-edit-admin/proc-edit-pag-admin.php';

//Captura de ID
$id = $_GET['id'];

//Executa consulta
$consulta_pag = "SELECT * FROM pag_admin WHERE id='$id'";
$resultado_pag = $conectar->query($consulta_pag);
$editar_pag_admin = mysqli_fetch_assoc($resultado_pag);
?>
                    ...
                    <form class="form-horizontal" id="edicao_pag_admin" method="POST" action="">
                        <div class="form-group">
                            <div class="col-sm-5">
                                ...
                                <input type="text" value="<?php echo $editar_pag_admin['name_pag']; ?>"
                                       data-toggle="tooltip" title="Digite uma página válida" class="form-control"
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                ...
                                <input type="text" value="<?php echo $editar_pag_admin['caminho']; ?>"
                        ...
                        <div class="form-group">
                            <div class="col-sm-5">
                                <input type="hidden" name="id" value="<?php echo $editar_pag_admin['id']; ?>">
                                <button type="submit" name="btnEditPagAdmin" value="Editar" accesskey="G"
                                        style="<?php if ($_SESSION['usuarioNivelAcesso'] <> 1) {
                                            echo 'display: none;';
                                ...
                                <a href='././<?php echo $admin?>?pag=list-pag-admin'
