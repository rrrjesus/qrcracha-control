    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-header">
                <ol class="breadcrumb">
                    <li><i class="fa fa-database"></i> <a href="<?php echo $admin;?>">Sisdam Web</a></li>
    ...
    <div class="row espaco">
        <div class="col-md-12">
            <form class="form-horizontal" style="<?php if ($_SESSION['usuarioNivelAcesso'] > 3) {
                ...
                if ($status == '0') { ?>
                    <?php $conectar->query("UPDATE usuarios SET status = '1', usuarioalt = '$usuariologin', alterado =  NOW() WHERE id = '$id'");
                    $_SESSION['msgativo'] = "<div class='alert alert-success text-center'><strong>LOGIN</strong> : $login - <strong>NOME</strong> : $nome - <strong>ATIVADO COM SUCESSO !!!</strong></div>";
                    header("Location: $admin"); ?>

                    <!-------------------------------------------------------------------------------------------------------------------------->
                <?php } else {
                    $conectar->query("UPDATE usuarios SET status = '0', usuarioalt = '$usuariologin', alterado =  NOW() WHERE id = '$id'");
                    $_SESSION['msginativo'] = "<div class='alert alert-danger text-center'><strong>LOGIN</strong> : $login - <strong>NOME</strong> : $nome - <strong>DESATIVADO COM SUCESSO !!!</strong></div>";
                    header("Location: $admin");
                } ?>
