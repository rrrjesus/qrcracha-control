...
<link rel="stylesheet" type="text/css" href="assets/css/locomotiva.css">
...
<!-- Estilos personalizados para este modelo de Carroussel-->
<link href="assets/css/carousel.css" rel="stylesheet">

<!-- Estilos personalizados para este modelo de Blog-->
...
<script type="text/javascript" src="assets/js/jquery/validation/val_contato.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-sv2.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-sv2-siva.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-sv2-surto.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/validation-sv2-covid.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-memo.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-tid.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-pesquisar.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-ambiental.js"></script>
<script type="text/javascript" src="assets/js/jquery/validation/val-sanitaria.js"></script>
...
<!-- Calendário em : https://api.jqueryui.com/datepicker/ -->
<script type="text/javascript" src="assets/js/md5/md5.js"></script>
